...
class DetailInfo extends React.Component<DetailProps, DetailState>{
    state: DetailState = {
        showCartModal: false,
    };
                    ...
                    <div className="dettail-info-box">
                        ...
                        <div className="detail-info-content">
                            ...
                            <div className="count-container">
                                ...
                                <button type='button' onClick={this.showModal}>Add To Card</button>
                                <ShoppingCartModal
